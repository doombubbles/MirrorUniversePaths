...
public class SunNonTemplePath : PathPlusPlus
{
    ...
    public override string DisplayName => "Non-Temple";
    public override string Description => "Doesn't become a Temple or enact sacrifices.";
}